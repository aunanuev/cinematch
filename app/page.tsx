    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#0B1220] via-[#0F172A] to-[#020617] text-gray-100 font-sans">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="sticky top-16 z-40 bg-[#0B1220]/80 backdrop-blur-md border-b border-white/5">
                    {/* Watch-status tabs */}
                ...
                <main className="flex-1 px-3 pt-2 pb-28">
                    ...
                    {filteredMovies.length > 0 && (
                        groupByGenre ? (
                            ...
                            <MovieGrid movies={filteredMovies} viewMode={viewMode} collectionTags={allVibeTags} />
                        )
                    )}
                </main>
            </div>
